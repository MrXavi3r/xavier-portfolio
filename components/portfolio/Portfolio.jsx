...
const Portfolio = () => {
  ...
  return (
    ...
    >
      ...
      <div className="container flex items-center justify-center flex-wrap overflow-auto h-full w-full">
        {data.map((d) => {
          return (
            <div
              className="mx-4 md:w-3/5 w-full rounded-xl flex items-center justify-center text-white cursor-pointer relative hover:bg-indigo-900 transition-all duration-500 ease-in-out"
              key={d.id}
            >
              <Image
                src={d.img}
